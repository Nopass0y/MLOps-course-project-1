...
from config.model_parameter import *
...
class ModelTraining:
    ...
    def train_lgbm(self,X_train,y_train):
        try:
            ...
            raise CustomerException("Failed to train model" ,  e)
    ...
    def evaluate_model(self , model , X_test , y_test):
        try:
            ...
            raise CustomerException("Failed to evaluate model" ,  e)
    ...
    def save_model(self,model):
        try:
            ...
            raise CustomerException("Failed to save model" ,  e)
    ...
    def run(self):
        try:
            ...
            raise CustomerException("Failed during model training pipeline" ,  e)
