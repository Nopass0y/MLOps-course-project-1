...
class DataProcessor:
    ...
    def preprocess_data(self,df):
        try:
            ...
            raise CustomerException("Error while preprocess data", e)
    ...
    def balance_data(self,df):
        try:
            ...
            raise CustomerException("Error while balancing data", e)
    ...
    def select_features(self,df):
        try:
            ...
            raise CustomerException("Error while feature selection", e)
    ...
    def save_data(self,df , file_path):
        try:
            ...
            raise CustomerException("Error while saving data", e)
    ...
    def process(self):
        try:
            ...
            raise CustomerException("Error while data preprocessing pipeline", e)
